...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Pills',
          path: '/pills',
          builder: (context, params) => const PillsWidget(),
        ),
        FFRoute(
          name: 'FAQs',
          path: '/fAQs',
        ...
        FFRoute(
          name: 'General',
          path: '/general',
          builder: (context, params) => const GeneralWidget(),
        ),
        FFRoute(
          name: 'QRCode',
          path: '/qRCode',
        ...
        FFRoute(
          name: 'PillInfo',
          path: '/pillInfo',
          builder: (context, params) => PillInfoWidget(
            pillName: params.getParam(
              'pillName',
              ParamType.String,
            ),
            futurepills: params.getParam<String>(
              'futurepills',
              ParamType.String,
              isList: true,
            ),
