...
class _PillWidgetState extends State<PillWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PillModel());
              ...
              child: Column(
                ...
                children: [
                  Align(
                    ...
                    child: Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(0.0, 30.0, 15.0, 15.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                          Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: ((_model.textController1.text == '') ||
                            ...
                            : () async {
                                ...
                                await PillsRecord.collection.doc().set({
                                  ...createPillsRecordData(
                                    medName: _model.textController1.text,
                                    medCount: int.tryParse(
                                        _model.textController2.text),
                                    owner: currentUserUid,
                                    reminder: int.tryParse(
                                        _model.textController3.text),
                                  ),
                                  ...mapToFirestore(
                                    {
                        ...
                        options: FFButtonOptions(
                          ...
                          borderRadius: BorderRadius.circular(8.0),
                          disabledColor: const Color(0xFF787878),
                        ),
                      ),
                    ),
                  ),
